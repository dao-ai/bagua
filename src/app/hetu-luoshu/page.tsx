  ...
  return (
    <svg viewBox="0 0 400 200" className="w-full max-w-[400px] mx-auto" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(100,100)">
        <circle cx="0" cy="-40" r="4" fill="#3b82f6" />  {/* 1 北水 */}
        ...
        <circle cx="0" cy="40" r="4" fill="#3b82f6" />  {/* 2 南火 */}
        ...
        <circle cx="-40" cy="0" r="4" fill="#3b82f6" /> {/* 3 东木 */}
        ...
        <circle cx="40" cy="0" r="4" fill="#3b82f6" />   {/* 4 西金 */}
        ...
        <circle cx="0" cy="0" r="5" fill="#f59e0b" />   {/* 5 中土 */}
        {[0,1,2,3,4].map(i => {
